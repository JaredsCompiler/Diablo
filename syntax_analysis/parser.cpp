...
#line 167 "parser.cpp"
    ...
    : super_type (YY_MOVE (that.state), YY_MOVE (that.location))
  {
    switch (that.kind ())
    {
      ...
      case 3: // "identifier"
      case 10: // "geometric_op"
      case 11: // "arithmetic_op"
      case 12: // "operator"
...
#line 141 "parser.y"
        {
            ...
            for(auto element : yystack_[0].value.as <  std::vector<long long int>  > ()){
...
#line 148 "parser.y"
        {
            ...
            for(auto element : yystack_[0].value.as <  std::vector<double>  > ()){
                std::cout << element << std::endl;
            }
        }
#line 699 "parser.cpp"
...
#line 216 "parser.y"
        {
            const std::vector<double> cont = yystack_[0].value.as <  std::vector<double>  > ();
            long long int val = cont.back();
            std::map<std::string, double>::iterator it = symbolTable.find(yystack_[2].value.as < std::string > ());
            if(it != symbolTable.end()){
                std::cout << "updating value " << yystack_[2].value.as < std::string > () << " with value of " << symbolTable[yystack_[2].value.as < std::string > ()] << " to value of " << val << std::endl;
            } else {
                std::cout << "inserting " << yystack_[2].value.as < std::string > () << " with value of " << val << std::endl; 
            }
            symbolTable[yystack_[2].value.as < std::string > ()] = val;
        }
#line 743 "parser.cpp"
    break;
...
#line 228 "parser.y"
        {
            std::cout << yystack_[4].value.as < std::string > () << " = (" << yystack_[1].value.as <  std::vector<long long int>  > ().back() << ")" << std::endl;
            symbolTable[yystack_[4].value.as < std::string > ()] = yystack_[1].value.as <  std::vector<long long int>  > ().back();
        }
#line 752 "parser.cpp"
    break;
...
#line 233 "parser.y"
        {
            std::cout << yystack_[2].value.as < std::string > () << " = (" << yystack_[0].value.as <  std::vector<long long int>  > ().back() << ")" << std::endl;
            symbolTable[yystack_[2].value.as < std::string > ()] = yystack_[0].value.as <  std::vector<long long int>  > ().back();
        }
#line 761 "parser.cpp"
    break;
...
#line 238 "parser.y"
        {
            std::cout << "got value of " << yystack_[0].value.as <  double  > () << std::endl;
        }
#line 769 "parser.cpp"
    break;
...
#line 272 "parser.y"
        {
            std::cout << "arguments: " << "number " << "(" << yystack_[0].value.as < long long int > () << ")" << std::endl;
...
#line 331 "parser.y"
        ...
        std::cout << "arguments: " << "number " << "(" << yystack_[0].value.as < long long int > () << ")" << std::endl;
        double number = yystack_[0].value.as < long long int > ();
...
#undef YYCASE_
  ...
  const signed char
   Parser ::yypact_[] =
  {
      -7,     1,    -7,    -6,     7,     6,    -7,    13,     9,    -7,
      11,    15,    -7,    -4,    14,    18,    20,    -7,    11,    -7,
       8,    -7,    -7,     6,     9,     3,    16
  };
  ...
  const signed char
   Parser ::yydefact_[] =
  {
       2,     0,     1,    15,    12,     0,     6,     7,     3,     5,
       4,     0,    12,     0,     0,     0,     0,    16,     8,    14,
       0,    13,    17,     0,    10,     0,     9
  };
  ...
  const signed char
   Parser ::yytable_[] =
  {
      13,     2,    19,    11,     3,     4,     5,    15,     6,    26,
      12,     5,    12,    23,    15,    24,    14,   -16,    25,    17,
      15,    16,    21,    20,    22,     0,     0,   -14,    18
  };

  const signed char
   Parser ::yycheck_[] =
  {
       5,     0,     6,     9,     3,     4,     5,    11,     7,     6,
       4,     5,     4,     5,    11,    20,     3,    10,    23,     4,
      11,    10,     4,     9,     4,    -1,    -1,    11,    11
  };

  const signed char
   Parser ::yystos_[] =
  {
       0,    14,     0,     3,     4,     5,     7,    15,    16,    17,
      18,     9,     4,    16,     3,    11,    10,     4,    18,     6,
       9,     4,     4,     5,    16,    16,     6
  };
  ...
  "\"comma\"", "\"assignment\"", "\"geometric_op\"", "\"arithmetic_op\"",
  "\"operator\"", "$accept", "program", "assignmentRule", "expression",
  "id", "term", YY_NULLPTR
  };
#endif
  ...
  const short
   Parser ::yyrline_[] =
  {
       0,   132,   132,   140,   147,   154,   157,   162,   215,   227,
     232,   237,   271,   278,   292,   310,   331,   338
  };
