...
#line 171 "parser.y"
        {
           yylhs.value.as <  EzAquarii::Command  > () = Command("filler", yystack_[2].value.as <  std::vector<uint64_t>  > ());
        }
#line 719 "parser.cpp"
    break;
...
#undef YYCASE_
  ...
  const signed char
   Parser ::yypact_[] =
  {
      -5,     0,    -5,    -4,    -5,     8,    -5,    14,     7,    12,
       3,     8,    16,    -5,     4,    11,     5,    -5,    -5,    -5,
      -5
  };
  ...
  const signed char
   Parser ::yydefact_[] =
  {
       2,     0,     1,     0,    12,     0,     4,     3,    11,     0,
       0,     0,     0,     6,     0,     8,     0,    13,     7,     9,
      10
  };
  ...
  const signed char
   Parser ::yytable_[] =
  {
       2,     9,    10,     3,     4,     5,    14,     6,    16,    15,
      18,    20,     4,    12,    12,    12,     4,    12,    13,    11,
      17,    19
  };
  ...
  const signed char
   Parser ::yycheck_[] =
  {
       0,     5,     5,     3,     4,     5,     9,     7,    11,     6,
       6,     6,     4,    10,    10,    10,     4,    10,     6,     5,
       4,    10
  };
  ...
  const signed char
   Parser ::yystos_[] =
  {
       0,    12,     0,     3,     4,     5,     7,    13,    14,     5,
      14,     5,    10,     6,    14,     6,    14,     4,     6,    10,
       6
  };
  ...
  const unsigned char
   Parser ::yyrline_[] =
  {
       0,   117,   117,   130,   137,   142,   153,   159,   166,   170,
     174,   180,   246,   252
  };
