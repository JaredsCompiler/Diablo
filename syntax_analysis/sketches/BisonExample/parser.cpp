...
#line 216 "parser.y"
        {
            ...
            std::map<std::string, uint64_t>::iterator it = symbolTable.find(yystack_[2].value.as < std::string > ());
            if(it != symbolTable.end()){
                std::cout << "updating value " << yystack_[2].value.as < std::string > () << " with value of " << symbolTable[yystack_[2].value.as < std::string > ()] << " to value of " << val;
            } else {
...
#undef YYCASE_
  ...
  const signed char
   Parser ::yydefact_[] =
  {
       2,     0,     1,    13,    15,     0,     4,     3,     6,    11,
       0,     0,     0,    14,     0,     7,     0,     0,    12,     9,
      16,     8
  };
  ...
  const short
   Parser ::yyrline_[] =
  {
       0,   132,   132,   145,   152,   157,   165,   176,   182,   189,
     193,   205,   215,   227,   239,   258,   264
  };
