...
#line 148 "parser.y"
        {
            cout << yystack_[2].value.as < uint64_t > () << "+" << yystack_[0].value.as < uint64_t > () << endl;
            print_mess();
            yylhs.value.as <  EzAquarii::Command  > () = Command("Hello");
        }
#line 696 "parser.cpp"
    break;
...
#undef YYCASE_
  ...
  "\"comma\"", "\"addition\"", "$accept", "program", "command",
  ...
  const unsigned char
   Parser ::yyrline_[] =
  {
       0,   106,   106,   119,   126,   134,   140,   147,   155,   162
  };
