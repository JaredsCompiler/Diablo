...
#line 179 "parser.y"
        {
           yylhs.value.as <  EzAquarii::Command  > () = Command("filler", yystack_[1].value.as <  std::vector<uint64_t>  > ());
        }
#line 725 "parser.cpp"
    break;
...
#line 183 "parser.y"
        {
          yylhs.value.as <  EzAquarii::Command  > () = Command("filler", yystack_[0].value.as <  std::vector<uint64_t>  > ());
        }
#line 733 "parser.cpp"
    break;
...
#line 193 "parser.y"
        {
            const std::vector<uint64_t> cont = yystack_[0].value.as <  EzAquarii::Command  > ().args();
            uint64_t val = cont.back();
            std::map<std::string, uint64_t>::iterator it = symbols.find(yystack_[2].value.as < std::string > ());
            ...
            /*symbolTable[$1] = val;*/
            symbols[yystack_[2].value.as < std::string > ()] = val;
        }
#line 752 "parser.cpp"
    break;
...
#line 208 "parser.y"
        {
            ...
            if(gottem == std::numeric_limits<uint64_t>::infinity()){
                std::cerr << "we could not find " << yystack_[0].value.as < std::string > () << std::endl;
            } else {
                std::cout << yystack_[0].value.as < std::string > () << " has a value of " << gottem << std::endl;
            }
...
#line 234 "parser.y"
        {
            std::cout << "arguments: " << "number " << "(" << yystack_[0].value.as < uint64_t > () << ")" << std::endl;
...
#undef YYCASE_
  ...
  const signed char
   Parser ::yydefact_[] =
  {
       2,     0,     1,    11,    13,     0,     4,     3,     5,     9,
       0,     0,     0,    12,     0,     6,     0,     0,    10,     8,
      14,     7
  };
  ...
  const signed char
   Parser ::yytable_[] =
  {
       2,     4,    14,     3,     4,     5,    12,     6,    10,    13,
      19,    16,    11,    21,    14,    20,    18,    14,    17,     4,
       5,     4,     0,    15,    10
  };
  ...
  const signed char
   Parser ::yycheck_[] =
  {
       0,     4,    10,     3,     4,     5,     5,     7,     5,     8,
       6,    10,     9,     6,    10,     4,    11,    10,     3,     4,
       5,     4,    -1,     6,     5
  };
  ...
  const signed char
   Parser ::yystos_[] =
  {
       0,    12,     0,     3,     4,     5,     7,    13,    14,    15,
       5,     9,    15,    15,    10,     6,    15,     3,    13,     6,
       4,     6
  };
  ...
  "\"comma\"", "\"assignment\"", "\"operator\"", "$accept", "program",
  "command", "assignmentRule", "arguments", YY_NULLPTR
  };
#endif
  ...
  const unsigned char
   Parser ::yyrline_[] =
  {
       0,   130,   130,   143,   150,   155,   165,   171,   178,   182,
     192,   207,   220,   233,   240
  };
