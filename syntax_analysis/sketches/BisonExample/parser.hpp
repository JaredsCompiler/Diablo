  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_assignmentRule = 14,                   // assignmentRule
        S_arguments = 15                         // arguments
      };
    };
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
        YY_ASSERT (tok == token::TOKEN_STRING || tok == token::TOKEN_OPERATOR);
      }
#else
